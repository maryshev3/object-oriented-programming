...
[Следующее задание: Кейс CoffeeBucks →](/object-oriented-programming/ru/case-coffeebucks)

[Предыдущая тема: Введение в Git →](/object-oriented-programming/ru/git-intro)