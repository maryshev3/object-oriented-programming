...
[Следующее задание: Разработка RULES.md →](/ru/create-rules)

[Предыдущая лабораторная работа: Ввод/вывод в C++. Библиотеки ввода/вывода →](/ru/io-streams-laboratory-work)