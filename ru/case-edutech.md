...
[Следующее задание: Разработка RULES.md →](/object-oriented-programming/ru/create-rules)

[Предыдущая лабораторная работа: Ввод/вывод в C++. Библиотеки ввода/вывода →](/object-oriented-programming/ru/io-streams-laboratory-work)