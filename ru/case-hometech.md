...
[Следующая тема: Ввод/вывод в C++. Библиотеки ввода/вывода →](/object-oriented-programming/ru/io-streams)

[Предыдущее задание: Кейс ConsolePaint →](/object-oriented-programming/ru/case-consolepaint)