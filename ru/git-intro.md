...
![Создание нового репозитория]({{ '/assets/images/git-intro/1.png' | relative_url }}){: .center-img }
...
<div class="task-box">
  ...
  Выберите на сайте LeetCode (<a href="https://leetcode.com/problemset/">https://leetcode.com/problemset/</a>) любую задачу и оформите её решение в виде отдельного C++ решения.

  Залейте оформленное решение в репозиторий GitHub.
...
![Переход к списку веток]({{ '/assets/images/git-intro/2.png' | relative_url }}){: .center-img }
...
![Переход к созданию ветки]({{ '/assets/images/git-intro/3.png' | relative_url }}){: .center-img }
...
![Ввод имени для ветки]({{ '/assets/images/git-intro/4.png' | relative_url }}){: .center-img }
...
![Добавление файла]({{ '/assets/images/git-intro/5.png' | relative_url }}){: .center-img }
<p style="text-align: center;">Рисунок 5 – Добавление файла</p>

- Введём название для файла (Рисунок 6).

![Ввод названия для файла]({{ '/assets/images/git-intro/6.png' | relative_url }}){: .center-img }
...
![Список изменений]({{ '/assets/images/git-intro/7.png' | relative_url }}){: .center-img }
...
![Фиксация изменений]({{ '/assets/images/git-intro/8.png' | relative_url }}){: .center-img }
...
![Создание коммита]({{ '/assets/images/git-intro/9.png' | relative_url }}){: .center-img }
...
![Ветки в GitHub после фиксации изменений]({{ '/assets/images/git-intro/10.png' | relative_url }}){: .center-img }
...
![Наличие файла в разных ветках]({{ '/assets/images/git-intro/11.png' | relative_url }}){: .center-img }
...
![Создание Pull Request]({{ '/assets/images/git-intro/12.png' | relative_url }}){: .center-img }
...
![Выбор веток для слияния]({{ '/assets/images/git-intro/13.png' | relative_url }}){: .center-img }
...
![Слияние веток]({{ '/assets/images/git-intro/14.png' | relative_url }}){: .center-img }
...
![Удаление ветки после слияния]({{ '/assets/images/git-intro/15.png' | relative_url }}){: .center-img }
