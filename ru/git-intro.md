...
<figure>
    <img src="/assets/images/git-intro/1.png" alt="Создание нового репозитория" />
    <figcaption>Рисунок 1 – Создание нового репозитория</figcaption>
</figure>
...
Рисунок - Добавление файла

- Введём название для файла (Рисунок 6).

Рисунок - Ввод названия для файла
...
Рисунок - Выбор веток для слияния
...
Рисунок - Удаление ветки после слияния
